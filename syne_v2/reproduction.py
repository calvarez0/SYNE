...
from syne_v2.genome import Genome, crossover, fuse, create_initial_genome
from syne_v2.species import Species, SpeciesSet
from syne_v2.config import Config
from syne_v2.innovation import get_innovation_tracker
...
class SymbioticReproduction:
    ...
    def _add_hidden_node(self, genome: Genome) -> None:
        ...
        from syne_v2.genome import NodeGene, ConnectionGene
        from syne_v2.innovation import get_innovation_tracker
